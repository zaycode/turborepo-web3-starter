...
export const getContractAddress = (contractName: keyof typeof contractAddresses, chainId: number): Address => {
  return contractAddresses[contractName][chainId] || "0x0000000000000000000000000000000000000000"
}
